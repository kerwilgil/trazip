export namespace api {
	...
	export class OSINTExecuteResult {
	    data: any;
	    provenance: osint.Provenance;
	    err?: string;
	
	    static createFrom(source: any = {}) {
	        return new OSINTExecuteResult(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.data = source["data"];
	        this.provenance = this.convertValues(source["provenance"], osint.Provenance);
	        this.err = source["err"];
	    }
